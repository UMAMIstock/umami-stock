...
const S = {
  ...
  cardGrid:    { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(120px, 1fr))", gap: 10 },
  card:        { background: "#fff", border: "1.5px solid #dde1e9", borderRadius: 12, overflow: "hidden" },
  ...
  input:       { background: "#fff", border: "1px solid #dde1e9", color: "#1a1f2e", padding: "9px 12px", borderRadius: 7, fontSize: 14, fontFamily: "'Noto Sans JP', sans-serif", outline: "none", width: "100%", boxSizing: "border-box" },
  textarea:    { background: "#fff", border: "1px solid #dde1e9", color: "#1a1f2e", padding: "9px 12px", borderRadius: 7, fontSize: 14, fontFamily: "'Noto Sans JP', sans-serif", outline: "none", width: "100%", minHeight: 80, resize: "vertical", boxSizing: "border-box" },
  select:      { background: "#fff", border: "1px solid #dde1e9", color: "#1a1f2e", padding: "9px 12px", borderRadius: 7, fontSize: 14, fontFamily: "'Noto Sans JP', sans-serif", outline: "none", width: "100%", boxSizing: "border-box" },
  editInline:  { marginTop: 10, display: "flex", flexDirection: "column", gap: 7 },
  editInput:   { padding: "6px 10px", fontSize: 13, borderRadius: 6, border: "1px solid #dde1e9", background: "#f0f2f5", color: "#1a1f2e", fontFamily: "'Noto Sans JP', sans-serif", width: "100%", boxSizing: "border-box" },
  ...
  empty:       { textAlign: "center", padding: "60px 20px", color: "#7a8599" },
